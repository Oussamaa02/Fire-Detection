...
import ps.fireDetection.ps.auth.AuthenticationRequest;
import ps.fireDetection.ps.auth.RegisterRequest;
import ps.fireDetection.ps.config.JwtService;
import ps.fireDetection.ps.token.Token;
import ps.fireDetection.ps.token.TokenRepository;
import ps.fireDetection.ps.token.TokenType;
import ps.fireDetection.ps.user.Role;
import ps.fireDetection.ps.user.User;
import ps.fireDetection.ps.user.UserRepository;
