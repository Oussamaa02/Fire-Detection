...
const int redPin = 21;  // R pin
const int greenPin = 19; // G pin
const int bluePin = 5;  // B pin
...
void loop() {
  ...
  if (now - lastMsg > 2000) {
   ...
   int sensorValue = analogRead(mq5Pin);
    ...
    turnOffLED(); // Turn off LED if no value
  }

    // value = value + 2;
    snprintf (msg, MSG_BUFFER_SIZE, "MQ5 Sensor Value: %ld", sensorValue);
    Serial.print("Publish message: ");
    Serial.println(msg);
    client.publish("sensor/mq5", msg);
  }
}
